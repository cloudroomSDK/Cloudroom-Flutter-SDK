...
class CrLoginResult {
  ...
  CrLoginResult({required this.userID, required this.sdkErr});
}

class CrMeetInfo {
  int confId; // 房间号，数值0代表房间信息无效
  int sdkErr;
  CrMeetInfo({required this.confId, required this.sdkErr});
}

class CrChangeNickName {
  String userId;
  String newName;
  String? oldName;
  int? sdkErr;
  ...
  CrChangeNickName(
      {required this.userId, required this.newName, this.oldName, this.sdkErr});
}
